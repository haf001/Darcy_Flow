...
for m in range (25, 175, 25):
    ...
    # Plotting Pressure Gradient, Difference_in_Numeric_&_Exact_Pressure and Velocity_Profile
    #xdmf = XDMFFile('Pressure_Gradient.xdmf')
    #xdmf.write(p)
    #xdmf.close()

    #xdmf = XDMFFile('Difference_in_Pressure.xdmf')
    #xdmf.write(diff_p)
    #xdmf.close()
